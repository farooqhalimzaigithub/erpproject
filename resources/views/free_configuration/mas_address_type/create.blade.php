 ...
 <div class="card card-form" >
                                <div class="row no-gutters">
                                    ...
                                    <div class="col-lg-12 card-form__body card-body">
                                        <form action="{{route('mas_address_types.store')}}" method="POST">
                                          @csrf
                                            <div class="">
                                                <div class="form-row">
                                                ...
                                                <input type="text"
                                                       class="form-control"
                                                       id="exampleInputEmail1" name="address_type_name">
                                                ...
                                                <div class="form-row">
                                                     <div class="col-12 col-md-6 mb-3">
                                                        ...
                                                        <textarea type="text"
                                                               class="form-control"
                                                               id="validationSample02" name="description" required=""></textarea>
